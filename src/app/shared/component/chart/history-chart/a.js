...
//       "sType": "string",
//       "aTargets": [1],
//       "render": constrainName
//     }, {"sType": "currency", "aTargets": [2]}, {"sType": "price", "aTargets": [3]}, {
//       "sType": "volume",
//       "aTargets": [4]
//     }, {"sType": "totalsupply", "aTargets": [5]}, {"sType": "percent", "aTargets": [6]}, {
//       "bSortable": false,
//       "aTargets": [7]
...
//     "bPaginate": false,
//     "bStateSave": false,
//     "aoColumnDefs": [{"bSortable": false, "aTargets": [0]}, {"sType": "string", "aTargets": [1]}, {
//       "sType": "string",
//       "aTargets": [2]
//     }, {"sType": "currency", "aTargets": [3]}, {"sType": "price", "aTargets": [4]}, {
//       "sType": "totalsupply",
//       "aTargets": [5]
//     }, {"sType": "volume", "aTargets": [6]}, {"sType": "percent", "aTargets": [7]}, {
//       "sType": "percent",
//       "aTargets": [8]
//     }, {"sType": "percent", "aTargets": [9]}, {"asSorting": ["desc", "asc"], "aTargets": [3, 4, 5, 6, 7, 8, 9]},],
//     "sDom": 't',
//     "language": getLanguageOptions()
//   });
//   if (tables.length) {
...
//       "aTargets": [1],
//       "render": constrainName
//     }, {"sType": "string", "aTargets": [2]}, {"sType": "currency", "aTargets": [3]}, {
//       "sType": "price",
//       "aTargets": [4]
//     }, {"sType": "volume", "aTargets": [5]}, {"sType": "totalsupply", "aTargets": [6]}, {
//       "sType": "percent",
//       "aTargets": [7]
//     }, {"bSortable": false, "aTargets": [8]}, {"asSorting": ["desc", "asc"], "aTargets": [3, 4, 5, 6, 7]},],
//     "language": getLanguageOptions()
//   };
...
//       "sType": "innerstring",
//       "aTargets": [1]
//     }, {"sType": "innerstring", "aTargets": [2]}, {"sType": "volume", "aTargets": [3]}, {
//       "sType": "price",
//       "aTargets": [4]
//     }, {"sType": "percent", "aTargets": [5]}, {"sType": "string", "aTargets": [6]}, {
//       "asSorting": ["desc", "asc"],
//       "aTargets": [3, 4, 5]
//     },],
//     "language": getLanguageOptions()
...
//       "sType": "string",
//       "aTargets": [2]
//     }, {"sType": "volume", "aTargets": [3]}, {"sType": "volume", "aTargets": [4]}, {
//       "sType": "volume",
//       "aTargets": [5]
...
//     "language": getLanguageOptions()
//   });
//   currenciesVolume.on('order.dt search.dt', function () {
//     currenciesVolume.column(0, {order: 'applied'}).nodes().each(function (cell, i) {
//       cell.innerHTML = i + 1;
//     });
//   }).draw();
...
//       var $div = $('<div>');
//       $div.html(a);
//       var priceContainer = $div.find('.price'), $container = priceContainer.length ? priceContainer : $div,
//         text = $container.text();
//       if (text == "?") {
//         return 0;
//       }
...
//       s = text.indexOf('-')
//       if (s > 0) {
//         e = parseInt(text.substring(s + 1))
//         text = parseFloat(text) * 1 / Math.pow(10, e)
//       } else {
...
//       var $div = $('<div>');
//       $div.html(a);
//       var $container, volumeContainer = $div.find('.volume'),
//         $container = volumeContainer.length ? volumeContainer : $div, usd = $container.data('usd'),
//         text = usd === undefined ? $container.text() : usd;
//       text = parseFloat(text)
//       if (isNaN(text)) {
//         text = -1;
//       }
...
//   });
//   jQuery.extend(jQuery.fn.dataTableExt.oSort, {
//     "innerstring-pre": function (a) {
//       a = $(a).text();
//       return a;
//     }, "innerstring-asc": function (a, b) {
//       return a - b;
//     }, "innerstring-desc": function (a, b) {
//       return b - a;
//     }
//   });
// });
...
//           }
//           if (selector_type !== '.price') {
//             amount = abbreviateIfMobile(amount);
//           }
//         }
...
// }
//
// function abbreviateIfMobile(data) {
//   if (MOBILE.isMobile()) {
//     var num = parseFloat((data === "-") ? 0 : data.replace(/[^\d\-\.]/g, ""));
//     if (!num) {
//       num = 0;
//     }
...
//     var $this = $(this), amount = $this.find('[data-supply]').data('supply');
//     if (amount === null || amount === "None") {
//       amount = "?";
//     }
//     if (amount !== "?") {
//       if (MOBILE.isMobile()) {
//         amount = abbreviateNumber(amount, 2);
//       } else {
...
//   renderCurrency({currency: currencyValue.toLowerCase(), label: currencyValue});
//   $(".price-toggle").click(function () {
//     var currency = $(this).data('currency');
//     var label = $(this).html();
//     renderCurrency({currency: currency, label: label});
//     dataLayer.push({
//       'event': 'customEvent',
...
//   renderCurrency({currency: currency.toLowerCase(), label: currency});
// });
// (function (h) {
...
//
//   function Ha(a, b, c, d) {
//     var e = [], f = b.firstChild, g, j, i = 0, n, l = a.aoColumns, q = a._rowReadObject, d = d !== k ? d : q ? {} : [],
//       t = function (a, b) {
//         if ("string" === typeof a) {
//           var c = a.indexOf("@");
...
//
//   function tb(a) {
//     var b = a.aoColumns, c = b.length, d = a.oFeatures, e = a.oPreviousSearch, f = a.aoPreSearchCols, g, j = [], i, n,
//       l, k = V(a);
//     g = a._iDisplayStart;
...
//       t = h(a.nScrollFoot).children("div"), m = t.children("table"), o = h(a.nTHead), p = h(a.nTable), s = p[0],
//       r = s.style, u = a.nTFoot ? h(a.nTFoot) : null, x = a.oBrowser, T = x.bScrollOversize, Xb = D(a.aoColumns, "nTh"),
//       O, K, P, w, Ta = [], y = [], z = [], A = [], B, C = function (a) {
//         a = a.style;
//         a.paddingTop = "0";
//         a.paddingBottom = "0";
//         a.borderTopWidth = "0";
...
//       i = la(a, "bVisible"), n = h("th", a.nTHead), l = b.getAttribute("width"), k = b.parentNode, t = !1, m, o,
...
//       this.each(function () {
//         var e = {}, g = 1 < d ? Jb(e, a, !0) : a, j = 0, i, e = this.getAttribute("id"), n = !1, l = m.defaults,
//           q = h(this);
...
//       var d = a, e = $a(c), f = b.aoData, g = Ba(b, e), j = Qb(ia(f, g, "anCells")), i = h([].concat.apply([], j)), l,
...
//     var n, r;
//     return t = t == null ? {} : t, typeof t == "number" && (t = {smart_count: t}), typeof this.phrases[e] == "string" ? n = this.phrases[e] : typeof t._ == "string" ? n = t._ : this.allowMissing ? n = e : (this.warn('Missing translation for key: "' + e + '"'), r = e), typeof n == "string" && (t = h(t), r = u(n, this.currentLocale, t.smart_count), r = l(r, t)), r
...
//     chart.update({yAxis: [{type: 'linear'}, {type: 'linear', floor: 0}, {type: 'linear', floor: 0}, {type: 'linear'}]});
//     dataLayer.push({
//       'event': 'customEvent',
...
//       }, {type: 'logarithmic', floor: 'null', gridLineWidth: marketCapEnabled ? 0 : 1}, {type: 'logarithmic'}]
//     });
//     dataLayer.push({
//       'event': 'customEvent',
//       'eventCategory': 'Highcharts',
...
//   var apiDomain = $("#metadata").data("apidomain");
//   timeParams = ""
//   if (start !== undefined && end !== undefined) {
//     timeParams = start + "/" + end + "/";
//   }
//   $.ajax({
//     url: apiDomain + "/currencies/" + slug + "/" + timeParams, type: "GET", dataType: "json", error: function () {
//       that.hideLoading();
//       that.showNoData();
...
//   var that = this;
//   Highcharts.setOptions({lang: defaultLangOptions(this.polyglot)});
//   $('#' + that.graphId).highcharts('StockChart', {
//     chart: {type: 'line', zoomType: 'x', height: is_mobile() ? 520 : 620, ignoreHiddenSeries: true},
//     responsive: {
//       rules: [{
...
//       }]
//     },
//     tooltip: {shared: true, hideDelay: 50, xDateFormat: this.polyglot.t('dateFormat')},
//     legend: {
//       enabled: true,
//       align: 'center',
...
//     title: {text: this.polyglot.t('chartTitle'), align: "left", style: {fontSize: "24px"}},
//     subtitle: {text: ''},
//     credits: {href: "https://coinmarketcap.com", text: "coinmarketcap.com",},
//     rangeSelector: {
//       allButtonsEnabled: true,
//       buttons: [{type: 'day', count: 1, text: this.polyglot.t('1d')}, {
//         type: 'week',
//         count: 1,
//         text: this.polyglot.t('7d')
//       }, {type: 'month', count: 1, text: this.polyglot.t('1m')}, {
//         type: 'month',
//         count: 3,
//         text: this.polyglot.t('3m')
//       }, {type: 'year', count: 1, text: this.polyglot.t('1y')}, {
//         type: 'ytd',
//         count: 1,
//         text: this.polyglot.t('ytd')
//       }, {type: 'all', text: this.polyglot.t('all')}],
//       selected: 6,
//       inputEnabled: true,
//       enabled: true
//     },
...
//       },
//       title: {text: this.polyglot.t('marketCap'), style: {color: '#7cb5ec', 'font-weight': 'bold'}},
//       showEmpty: false,
//       height: '80%',
//       opposite: false,
//       floor: 0,
...
//       title: {text: this.polyglot.t('priceUSD'), style: {color: '#009933', 'font-weight': 'bold'}},
//       showEmpty: false,
//       height: '80%',
//       opposite: true,
//       floor: 0
...
//       title: {text: this.polyglot.t('priceBTC'), style: {color: '#f7931a', 'font-weight': 'bold'}},
//       showEmpty: false,
//       height: '80%',
//       opposite: true,
//       floor: 0
...
//       title: {text: this.polyglot.t('volume'), style: {color: '#777', 'font-weight': 'bold'}},
//       showEmpty: false,
//       top: '80%',
//       height: '20%',
//       offset: 2,
...
//     },
//   });
//   that.bindLogScaleToggle($('#js-linear-mode'), $('#js-logarithmic-mode'))
//   that.hideLoading();
// }
// $(document).ready(function () {
